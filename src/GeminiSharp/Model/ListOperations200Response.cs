...
namespace GeminiSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListOperations_200_response")]
    public partial class ListOperations200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOperations200Response" /> class.
        /// </summary>
        /// <param name="operations">operations.</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        public ListOperations200Response(Collection<Operation> operations = default, string nextPageToken = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListOperations200Response {\n");
