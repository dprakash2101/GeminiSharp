...
namespace GeminiSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UploadFile_request_metadata")]
    public partial class UploadFileRequestMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadFileRequestMetadata" /> class.
        /// </summary>
        /// <param name="displayName">displayName.</param>
        /// <param name="mimeType">mimeType.</param>
        public UploadFileRequestMetadata(string displayName = default, string mimeType = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UploadFileRequestMetadata {\n");
