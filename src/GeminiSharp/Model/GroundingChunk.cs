...
namespace GeminiSharp.Model
{
    ...
    /// GroundingChunk
    /// </summary>
    [DataContract(Name = "GroundingChunk")]
    public partial class GroundingChunk : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroundingChunk" /> class.
        /// </summary>
        /// <param name="web">web.</param>
        public GroundingChunk(GroundingChunkWeb web = default)
        {
            this.Web = web;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroundingChunk {\n");
