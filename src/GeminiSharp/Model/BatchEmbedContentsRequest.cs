...
namespace GeminiSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchEmbedContents_request")]
    public partial class BatchEmbedContentsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchEmbedContentsRequest" /> class.
        /// </summary>
        /// <param name="requests">requests.</param>
        public BatchEmbedContentsRequest(Collection<BatchEmbedContentsRequestRequestsInner> requests = default)
        {
        ...
        public Collection<BatchEmbedContentsRequestRequestsInner> Requests { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchEmbedContentsRequest {\n");
