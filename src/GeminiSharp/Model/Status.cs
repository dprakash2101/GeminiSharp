...
namespace GeminiSharp.Model
{
    ...
    public partial class Status : IValidatableObject
    {
        ...
        /// <param name="details">A list of messages that carry the error details.</param>
        public Status(int code = default, string message = default, Collection<Object> details = default)
        {
            this.Code = code;
        ...
        /// </summary>
        /// <value>A developer-facing error message</value>
        ...
        /// </summary>
        /// <value>A list of messages that carry the error details</value>
