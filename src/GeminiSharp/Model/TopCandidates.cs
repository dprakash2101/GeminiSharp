...
namespace GeminiSharp.Model
{
    ...
    /// TopCandidates
    /// </summary>
    [DataContract(Name = "TopCandidates")]
    public partial class TopCandidates : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TopCandidates" /> class.
        /// </summary>
        /// <param name="candidates">Sorted by log probability in descending order.</param>
        public TopCandidates(Collection<CandidateLogprobs> candidates = default)
        {
        ...
        /// </summary>
        /// <value>Sorted by log probability in descending order</value>
        [DataMember(Name = "candidates", EmitDefaultValue = false)]
        public Collection<CandidateLogprobs> Candidates { get; set; }
