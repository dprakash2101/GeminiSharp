...
namespace GeminiSharp.Model
{
    ...
    public partial class ResponseContent : IValidatableObject
    {
        /// <summary>
        ...
        public ResponseContent(Collection<ResponseContentPart> parts = default, string role = default)
        {
            this.Parts = parts;
            this.Role = role;
        }
        ...
        public Collection<ResponseContentPart> Parts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseContent {\n");
