...
namespace GeminiSharp.Model
{
    ...
    /// ToolConfig
    /// </summary>
    [DataContract(Name = "ToolConfig")]
    public partial class ToolConfig : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolConfig" /> class.
        /// </summary>
        /// <param name="functionCallingConfig">functionCallingConfig.</param>
        public ToolConfig(FunctionCallingConfig functionCallingConfig = default)
        {
            this.FunctionCallingConfig = functionCallingConfig;
        }

        /// <summary>
        /// Gets or Sets FunctionCallingConfig
        /// </summary>
        [DataMember(Name = "functionCallingConfig", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FunctionCallingConfig: ").Append(FunctionCallingConfig).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
