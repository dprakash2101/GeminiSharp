...
namespace GeminiSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListModels_200_response")]
    public partial class ListModels200Response : IValidatableObject
    {
        ...
        public ListModels200Response(Collection<GeminiModel> models = default, string nextPageToken = default)
        {
            this.Models = models;
        ...
        public Collection<GeminiModel> Models { get; set; }
