...
namespace GeminiSharp.Model
{
    ...
    public partial class FunctionCall : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionCall" /> class.
        /// </summary>
        /// <param name="name">The name of the function to call.</param>
        /// <param name="args">The function parameters as key-value pairs.</param>
        public FunctionCall(string name = default, Object args = default)
        {
            this.Name = name;
            this.Args = args;
        }
        ...
        /// </summary>
        /// <value>The function parameters as key-value pairs</value>
