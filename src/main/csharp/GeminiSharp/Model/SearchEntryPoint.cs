...
namespace GeminiSharp.Model
{
    ...
    /// SearchEntryPoint
    /// </summary>
    [DataContract(Name = "SearchEntryPoint")]
    public partial class SearchEntryPoint : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchEntryPoint" /> class.
        /// </summary>
        /// <param name="renderedContent">Web content snippet that can be embedded in a web page or an app webview.</param>
        public SearchEntryPoint(string renderedContent = default)
        {
        ...
        /// </summary>
        /// <value>Web content snippet that can be embedded in a web page or an app webview</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchEntryPoint {\n");
